...
python main_train.py --algo 2 --folder scenario_3_lambd_2 --env_name q_learning --logdir ql_log --lambd 0.5 --lambd_evolve True --user_identical False --user_evolve False
