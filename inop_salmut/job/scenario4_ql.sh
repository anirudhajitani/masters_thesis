...
python main_train.py --algo 2 --folder scenario_4_lambd_2 --env_name q_learning --logdir ql_log --lambd 0.5 --lambd_evolve False --user_identical True --user_evolve True
