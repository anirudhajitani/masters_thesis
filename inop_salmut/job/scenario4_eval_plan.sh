...
python main_plan.py --algo 1 --folder scenario_4_lambd_2 --env_name thres_eval --logdir plan_log_s1 --lambd 0.5 --lambd_evolve False --user_identical True --user_evolve True
